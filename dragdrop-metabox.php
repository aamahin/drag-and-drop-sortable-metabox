...
add_action('admin_enqueue_scripts', function($pagename){
	...
	if(('post.php' == $pagename || 'post-new.php' == $pagename) && $typenow == 'page'){
		wp_enqueue_style('dragdrop-select2', '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css', [], null);
		wp_enqueue_style('dragdrop-style', get_template_directory_uri() . '/inc/drag-and-drop-sortable-metabox/css/style.css', [], null);
		
		wp_enqueue_script('jquery-ui-sortable');
		wp_enqueue_script('dragdrop-select2', '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js', [], null, true);
		wp_enqueue_script('dragdrop-script', get_template_directory_uri() . '/inc/drag-and-drop-sortable-metabox/js/scripts.js', [], null, true);
	}
});
